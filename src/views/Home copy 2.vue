              ...
              <div v-if="fileList.length" class="fileList flex1">
                ...
                >
                  ...
                  <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item @click.native="setBgImg('底图背景', n)"
      ...
      <div class="f-left main">
        <div class="tool-bar">
          <div class="tool-bar-left">
              ...
              <el-popover placement="bottom" trigger="click">
                ...
                <div class="flex1 flex1-item">
                  ...
                  <el-color-picker
                    show-alpha
                    v-model="activeElem.borderColor"
                    @active-change="colorChange($event, '底图边框')"
                    @change="colorChange($event, '底图边框')"
                    size="mini"
                  />
                  ...
                  @active-change="colorChange($event, '全局边框')"
            ...
            >
              ...
              <el-popover placement="bottom" trigger="click">
                <el-input-number
                  v-model="activeElem.borderRadius"
        ...
        <div class="edit-area">
          ...
          <div
            ...
            :style="{
              borderRadius: dituObj.borderRadius + 'px',
              border: outerBorder
                ? dituObj.borderSize + 'px solid ' + dituObj.borderColor
                : 0,
              boxShadow:
                dituObj.shadow1 +
                'px ' +
                ...
                dituObj.shadowColor +
                ' ' +
                dituObj.shadowDirection,
              backgroundColor: dituObj.backgroundColor,
              backgroundImage: 'url(' + dituObj.backgroundImage + ')',
...
export default {
  ...
  data () {
    return {
      ...
      activeElem: {},
      dituObj: {
        name: '底图', type: '底图', borderColor: '#000', borderSize: 5, backgroundColor: '', backgroundImage: '', shadow1: 0, shadow2: 0, shadow3: 0, shadowColor: '#000', shadowDirection: '', borderRadius: 0
      },
      outerShape: '矩形',
      fontBorderShape: '',
      shapeOpts: [
  ...
  methods: {
    menuHandle (i, e) {
      this.activeMenu = i
      // const line = document.getElementsByClassName('active-menu-line')[0]
      // const doms = document.getElementsByClassName('menu-item')
      // const domsArr = Array.from(doms)
      // const dom = domsArr[i]
      // const top = dom.top
      // const height = dom.height
      // console.log(e, dom, top, height, 123)
      // line.style.transform = 'translateY(' + (top + height * i / 2) + 'px)'
    },
    gHandle (e) {
    ...
    colorChange (val, type) {
      ...
      if (type === '输入文字') {
        ...
        this.activeElem.borderColor = val || '#fff'
      } else if (type === '背景') {
    ...
    setBgImg (type, n) {
      ...
      if (type === '图片') {
        ...
        this.dituObj.backgroundColor = ''
        this.dituObj.backgroundImage = n
      }
    },
    ...
    addToArea (type) {
      ...
      if (type === '输入文字') {
        ...
        el = { id: Date.now(), name: '圆圈', isActive: true, type: '圆圈', parentLimitation: false, w: 30, h: 30, x: 185, y: 185, zIndex: maxIndex, borderColor: '#000', borderSize: 1, backgroundColor: '', backgroundImage: '', rotate: 0, shadow1: 0, shadow2: 0, shadow3: 0, shadowColor: '#000', shadowDirection: '' }
      } else if (type === '矩形') {
        el = { id: Date.now(), name: '矩形', isActive: true, type: '矩形', parentLimitation: false, w: 30, h: 30, x: 185, y: 185, zIndex: maxIndex, borderColor: '#000', borderSize: 1, rotate: 0, backgroundColor: '', backgroundImage: '', shadow1: 0, shadow2: 0, shadow3: 0, shadowColor: '#000', shadowDirection: '' }
      } else if (type === '图片') {
        el = { id: Date.now(), name: '图片', isActive: true, type: '图片', parentLimitation: false, w: 30, h: 30, x: 185, y: 185, zIndex: maxIndex, rotate: 0, src: '' }
      }
      this.activeElem = el
      this.elemList.push(el)
